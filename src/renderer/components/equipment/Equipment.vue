  ...
  <div class="box">
    <div :class="computer">
        <el-form :inline="true" size="mini"  ref="searchForm" :model="searchForm" style="width:100%">
          ...
          <el-form-item  label-width="65px">
              <el-select size="mini" placeholder="选择机械类型" v-model="searchForm.kind" clearable  @change="getDeptByCompany">
              </el-select>
          </el-form-item>
          <el-form-item>
          ...
          <div style="margin-top: 17px;">
            <el-form-item  label-width="65px">
              <el-select size="mini" v-model="searchForm.comp" clearable  @change="getDeptByCompany">
              </el-select>
            </el-form-item>
          </div>
        </el-form>
    ...
    <keep-alive>
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column prop="bumen" label="部门" width></el-table-column>
        <el-table-column prop="leixing" label="机械类型" width></el-table-column>
        <el-table-column prop="mingcheng" label="机械名称" width></el-table-column>
        <el-table-column prop="bianhao" label="机械编号" width></el-table-column>
        <el-table-column prop="time" label="计划维保时间" width></el-table-column>
        <el-table-column prop="zhuangtai" label="数据状态" width></el-table-column>
        <el-table-column prop="neirong" label="数据内容" width></el-table-column>
      </el-table>
    </keep-alive>
    <!-- 分页区域 -->
    <div class="page">
      ...
      <el-drawer
        ...
        <div class="demo-drawer__content">
          <el-form :model="formone"  ref="formone" :rules="rules" style="padding-left:20px">
            <el-form-item label="部门：" :label-width="formLabelWidth" prop="bumen"> 
              <el-select v-model="formone.region" placeholder="请选择" size="mini" >
                <el-option label="大港公司" value="shanghai"></el-option>
                <el-option label="东港公司" value="beijing"></el-option>
              </el-select>
            </el-form-item>

            <el-form-item label="机械类型：" :label-width="formLabelWidth" prop="leixing">
              <el-select v-model="formone.region" placeholder="请选择" size="mini">
                <el-option label="大港公司" value="shanghai"></el-option>
                <el-option label="东港公司" value="beijing"></el-option>
              </el-select>
            ...
            <el-form-item label="机械名称：" :label-width="formLabelWidth" prop="name">
              <el-input v-model="formone.name" autocomplete="off" size="mini" style="width:72%"></el-input>
            </el-form-item>
            <el-form-item label="机械编号：" :label-width="formLabelWidth" prop="bianhao">
              <el-input v-model="formone.bianhao" autocomplete="off" size="mini" style="width:72%"></el-input>
            </el-form-item>
            <el-form-item label="维保类型：" :label-width="formLabelWidth" prop="weibao">
              <el-select v-model="formone.region" placeholder="请选择" size="mini">
                <el-option label="大港公司" value="shanghai"></el-option>
                <el-option label="东港公司" value="beijing"></el-option>
              </el-select>
            </el-form-item>  
            <el-form-item label="维保内容：" :label-width="formLabelWidth" prop="neirong"> 
              <el-input v-model="formone.neirong" autocomplete="off" size="mini" style="width:72%"></el-input>
            </el-form-item>
          ...
          <div class="demo-drawer__footer" style="padding-bottom:7px">
            <el-button @click="cancelFormone('formone')">保存并添加</el-button>
